    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (dao.excluir(idTipoProduto)) {
                mensagem = "TipoProduto excluido com Sucesso!";
            } else {
                mensagem = "Problemas ao excluir TipoProduto";
            }
            request.setAttribute("mensagem", mensagem);
            response.sendRedirect("TipoProdutoListar");
        } catch(Exception ex){
            System.out.println("Problemas no Servlet ao excluir TipoProduto! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
